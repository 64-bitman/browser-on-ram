CC := gcc
CFLAGS := -Wextra -Wall -Wshadow -std=gnu11 -ggdb -g3
...
TARGET_NAME := browser-on-ram
TARGET := $(BIN_PATH)/$(TARGET_NAME)

SRC := main.c util.c mkdir_p.c sync.c
OBJ := $(SRC:.c=.o)
...
run: all
	$(TARGET) -s '/home/user/Downloads/firefox/9gkyolu8.default' $(args)
